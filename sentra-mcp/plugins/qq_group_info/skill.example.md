...
- Single-call success: `result.success === true`, `result.code === "OK"`, and `data.request.path/requestId/args` + `data.response` are all present (`group_id, refresh`).
